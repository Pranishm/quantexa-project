...
(()=>{
    const e = new Error("Cannot find module './api-fallback'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
...
async function request(path, init = {}) {
    ...
    try {
        const fallback = getClientFallbackData(path, parsedBody);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0m06y6g._.js.map