...
(()=>{
    const e = new Error("Cannot find module './market-data-hub'");
...
function getClientFallbackData(path, body) {
    ...
    if (path.startsWith("/backtest")) {
        ...
        try {
            ...
            const periods = getAnnualizationDays(assetKey);
            return {
                strategy: {
                    name: strategyId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1ffme-j._.js.map