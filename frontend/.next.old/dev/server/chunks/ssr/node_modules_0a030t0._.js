...
class DataConflater {
    ...
    _private__chunkToSeriesPlotRow(chunk, isCustomSeries = false) {
        ...
        const data = isCustom ? hasCustomData ? chunk._internal_conflatedData : {
            _internal_time: chunk._internal_startTime
        } : undefined;
        return {
            ...base,
    ...
    _private__updateLastChunkInCache(originalData, newLastRow, conflationLevel, cachedRows, isCustomSeries = false, customReducer, priceValueBuilder) {
        ...
        if (lastChunkIndex === newChunkIndex || cachedRows.length === 1) {
            ...
            const mergedChunk = count === 1 ? this._private__plotRowToChunk(chunkStartIndex === lastOriginalIndex ? newLastRow : originalData[chunkStartIndex], /* isRemainder*/ true) : this._private__mergeRangeWithOverride(originalData, chunkStartIndex, actualEndIndex, lastOriginalIndex, newLastRow, customReducer, isCustomSeries, priceValueBuilder);
...
class Series extends PriceDataSource {
    ...
    _private__getConflationParams() {
        ...
        return {
            ...
            _internal_devicePixelRatio: devicePixelRatio,
            _internal_effectiveSmoothing: effectiveSmoothing
        };
    }
    ...
    _private__precomputeConflationLevels(priority) {
        ...
        for (const lvl of conflateFactors){
            ...
            const globalObj = ("TURBOPACK compile-time value", "undefined") === 'object' && window || typeof self === 'object' && self;
...
class PriceTickMarkBuilder {
    ...
    _private__computeBoundaryPriceMark(firstValue, coord, minPadding, maxPadding) {
        ...
        return {
            ...
            _internal_logical: roundedValue
        };
    }
...
function findBestPrimitiveHitTest(sources, x, y) {
    ...
    for (const source of sources){
        ...
        for (const hitResult of primitiveHitResults){
            ...
            if (comparePrimitiveZOrder(hitResult.zOrder, bestPrimitiveHit?.zOrder) || hitResult.zOrder === bestPrimitiveHit?.zOrder && bestPrimitiveCandidate !== undefined && isBetterHit(candidate, bestPrimitiveCandidate) || hitResult.zOrder === bestPrimitiveHit?.zOrder && bestPrimitiveCandidate === undefined) {
...
class PriceAxisWidget {
    ...
    _internal_paint(type) {
        ...
        if (type !== 1 /* InvalidationLevel.Cursor */ ) {
            ...
            const target = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$canvas$2d$rendering$2d$target$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tryCreateCanvasRenderingTarget2D"])(this._private__canvasBinding, canvasOptions);
            if (target !== null) {
        ...
        const topTarget = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fancy$2d$canvas$2f$canvas$2d$rendering$2d$target$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tryCreateCanvasRenderingTarget2D"])(this._private__topCanvasBinding, canvasOptions);
        if (topTarget !== null) {
...
class PaneWidget {
    ...
    _private__hoveredSplitSource() {
        ...
        if (!state._internal_model()._internal_options().hoveredSeriesOnTop || hoveredSource === undefined) {
            return null;
        }
...
class DataLayer {
    ...
    _internal_updateSeriesData(series, data, historicalUpdate) {
        ...
        const isLastBarUpdate = !historicalUpdate && !affectsTimeScale && lastSeriesTime !== undefined && this._private__horzScaleBehavior.key(time) === this._private__horzScaleBehavior.key(lastSeriesTime);
    ...
    _internal_popSeriesData(series, count) {
        ...
        if (seriesData === undefined || count <= 0) {
            return [
                [],
                this._private__emptyUpdateResponse()
            ];
        }
        ...
        return [
            poppedData,
            this._private__getUpdateResponse(series, this._private__sortedTimePoints.length - 1, info)
        ];
    }
...
function hoveredSeriesHitTestResult(distance, priority, itemType) {
    return {
        _internal_distance: distance,
        _internal_priority: priority,
        _internal_itemType: itemType
    };
}
...
class ChartApi {
    ...
    _private__convertMouseParams(param) {
        ...
        const hoveredInfo = param._internal_hoveredInfo === undefined ? undefined : {
...
function hitTestLineSegment(x, y, firstItem, secondItem, lineType, items, toItemIndex, radius) {
    switch(lineType){
        ...
        case 2 /* LineType.Curved */ :
            {
                const [firstControlPoint, secondControlPoint] = getControlPoints(items, toItemIndex - 1, toItemIndex);
                const distance = distanceToBezierCurve(x, y, [
                    firstItem,
                    firstControlPoint,
                    secondControlPoint,
                    secondItem
...
class SeriesBaselinePaneView extends LineHitTestPaneViewBase {
    constructor(series, model){
        ...
        this._private__normalPaneViews = [
            this
        ];
        this._private__topPaneViews = [
            this._private__linePaneView
        ];
...
__iconData.node;
const ArrowDownRight = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(__iconData);
;
}),
...
"[project]/node_modules/lucide-react/dist/esm/icons/chart-candlestick.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__iconData.node;
const ChartCandlestick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(__iconData);
;
}),
"[project]/node_modules/lucide-react/dist/esm/icons/chart-candlestick.mjs [app-ssr] (ecmascript) <export default as CandlestickChart>", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/lucide-react/dist/esm/icons/fast-forward.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__iconData.node;
const FastForward = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(__iconData);
;
}),
"[project]/node_modules/lucide-react/dist/esm/icons/fast-forward.mjs [app-ssr] (ecmascript) <export default as FastForward>", ((__turbopack_context__) => {
"use strict";
...
__iconData.node;
const Maximize2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(__iconData);
;
}),
...
"[project]/node_modules/lucide-react/dist/esm/icons/minimize-2.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__iconData.node;
const Minimize2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(__iconData);
;
}),
"[project]/node_modules/lucide-react/dist/esm/icons/minimize-2.mjs [app-ssr] (ecmascript) <export default as Minimize2>", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=node_modules_0a030t0._.js.map